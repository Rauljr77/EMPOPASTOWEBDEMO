        ...
        if (rows[i].isSelect) {
          ...
          if (_responseAuth.data.isAuthSuccessful) {
            ...
            if (_response.data.success) {
              toast.success(`Se asociaron los permisos de manera correcta`, CONFIG_TOAST);
              props.onAccept(true);
            } else toast.error(`Permiso en módulo ${rows[i].nombreModulo} ${_response.data.message}`, CONFIG_TOAST);  
          }
        }
      }
    }
        ...
        <form className='form'>
          ...
          <div className='row'>
            ...
            <div className='row m-0'>
              <div className='col-6'>
                <div className='row m-0'>
                  <button type='button' onClick={() => handleAssociatePermission()} className="btn btn-primary">Asociar perfil</button>
                </div>
              </div>
              <div className='col-6'>
                <div className='row m-0'>
                  <button type='button' onClick={props.onCancel} className="btn btn-secondary">Cancelar</button>
                </div>
              </div>
            </div>
